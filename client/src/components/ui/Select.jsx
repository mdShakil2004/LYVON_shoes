      ...
      <div className="relative">
        <button
          ...
          className={`
            ...
            bg-white text-black px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground 
                ...
                filteredOptions.map(option => (
                  <div
                    ...
                    className={`
                      ...
                      px-3 py-2 text-sm outline-none hover:bg-accent hover:text-accent-foreground
